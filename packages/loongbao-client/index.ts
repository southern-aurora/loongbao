...
export type LoongbaoClientOptions = {
...
export const createLoongbaoClient = <ApiSchema extends ApiSchemaExtend, FailCode extends FailCodeExtend>(options: LoongbaoClientOptions) => {
