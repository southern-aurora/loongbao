...
export async function buildClient() {
  ...
  await mkdir(join(cwd(), "package", "client", "dist"));
  await mkdir(join(cwd(), "package", "client", "generate"));

  // Generate the corresponding types for the files in the project and output them to the /package/client/generate directory.
