...
export const params = async (params: any) => ((input: any): typia.IValidation<Parameters<typeof helloWorld$get['api']['action']>[0]> => { const validate = (input: any): typia.IValidation<Parameters<typeof helloWorld$get['api']['action']>[0]> => {
    const errors = [] as any[];
    const __is = (input: any): input is Parameters<typeof helloWorld$get['api']['action']>[0] => {
    ...
    if (false === __is(input)) {
        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is Parameters<typeof helloWorld$get['api']['action']>[0] => {
...
}; const prune = (input: Parameters<typeof helloWorld$get['api']['action']>[0]): void => {
...
export const HTTPResults = async (results: any) => { type T = TSONEncode<ExecuteResultSuccess<Awaited<ReturnType<typeof helloWorld$get['api']['action']>>>>; return ((input: T): string => {
