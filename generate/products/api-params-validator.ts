...
export default {
    validate: {
        'hello-world/say-2': async (params: unknown) => ((input: any): typia.IValidation<Parameters<typeof helloWorld$say2['api']['action']>[0]> => { const validate = (input: any): typia.IValidation<Parameters<typeof helloWorld$say2['api']['action']>[0]> => {
            const errors = [] as any[];
        ...
        'hello-world/say': async (params: unknown) => ((input: any): typia.IValidation<Parameters<typeof helloWorld$say['api']['action']>[0]> => { const validate = (input: any): typia.IValidation<Parameters<typeof helloWorld$say['api']['action']>[0]> => {
            const errors = [] as any[];
